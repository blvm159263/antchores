...
namespace ProductService.Repositories.Migrations
{
    public partial class initialmigration : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP TABLE IF EXISTS Contracts");
            ...
            migrationBuilder.Sql("DROP TABLE IF EXISTS TaskDetails");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskDetails_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskerCerts", x => new { x.CategoryId, x.TaskerId });
                    table.ForeignKey(
                        name: "FK_TaskerCerts_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskerCerts_Taskers_TaskerId",
                        column: x => x.TaskerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contracts", x => new { x.OrderId, x.TaskerId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contracts_Taskers_TaskerId",
                        column: x => x.TaskerId,
                        principalTable: "Taskers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_TaskDetailId",
                table: "OrderDetails",
                column: "TaskDetailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskDetails_CategoryId",
                table: "TaskDetails",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskerCerts_TaskerId",
                table: "TaskerCerts",
                column: "TaskerId");
        }
